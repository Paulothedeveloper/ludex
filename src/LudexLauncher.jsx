...
// v0.8.51: helpers compartilhados (antes locais aqui)
import { invokeTimeout, validRomExtension } from "./ludexUtils";
...
// Em vez de redeclarar aqui, importa do modulo.

// SystemIcon_LOCAL deprecated — usar SystemIcon do ludexIcons.jsx via import no topo
function SystemIcon_LOCAL({ id }) {
